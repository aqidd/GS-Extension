...
var skel = function () {
    var a = {
        ...
        updateState: function () {
            ...
            for (b in e) if (d = a.breakpoints[e[b]], 0 != d.elements.length) for (c in d.elements) a.cache.states[a.stateId].elements.push(d.elements[c]), f.push(d.elements[c]);
        ...
        changeState: function (d) {
            ...
            a.DOMReady(function () {
                var a, b;
                if ((a = document.getElementsByClassName("skel-cell-mainContent")) && 0 < a.length) if (a = a[0], e.config.grid.collapse) b = document.createElement("div"), b.innerHTML = "", b.id = "skel-cell-mainContent-placeholder", a.parentNode.insertBefore(b, a.nextSibling), a.parentNode.insertBefore(a, a.parentNode.firstChild);
        ...
        newStyleSheet: function (a) {
            ...
            b.rel = "stylesheet";
            b.type = "text/css";
            //IMPORTANT : GET SIMPLE ONLY TWEAK
             	var z = "/Escape Velocity/" + a;
            	a = z;
            //END TWEAK
            b.href = a;
            return b
        ...
        initConfig: function () {
            function d(a, b) {
                var d;
                "string" != typeof b ? d = function (a) {
                    return !0
                } : "-" == b.charAt(0) ? (c[a] = parseInt(b.substring(1)), d = function (b) {
                    return b <= c[a]
                }) : "-" == b.charAt(b.length - 1) ? (c[a] = parseInt(b.substring(0, b.length - 1)), d = function (b) {
                    return b >= c[a]
                }) : -1 != b.indexOf("-") ? (b = b.split("-"), c[a] = [parseInt(b[0]), parseInt(b[1])], d = function (b) {
                    return b >= c[a][0] && b <= c[a][1]
                }) : (c[a] = parseInt(b), d = function (b) {
                    return b == c[a]
                });
                return d
            }
        ...
        init: function () {
            ...
            (function () {
                var b = window,
                    c = function (a) {
                        ...
                        a = !1;
                        if (!e) if (e = !0, "loading" !== d.readyState && l(), d.addEventListener) d.addEventListener("DOMContentLoaded", h, !1), b.addEventListener("load", h, !1);
            ...
            d.getElementsByClassName || (d.getElementsByClassName = function (a) {
                return d.querySelectorAll(("." + a.replace(" ", " .")).replace(/\.([0-9])/, ".\\3$1 "))
            });
            a.initConfig();
